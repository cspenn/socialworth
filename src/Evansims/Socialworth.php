...
class Socialworth
{
    ...
    public $services = array('twitter' => true, 'facebooklikes' => true, 'facebookcomments' => true, 'facebookshares' => true, 'pinterest' => true, 'reddit' => true, 
    //'hackernews'  => true,
        'googleplus' => true, 'stumbleupon' => true, 'linkedin' => true, 'testcase' => false);
    ...
    private function apiEndpoints()
    {
        return array(
            'facebookshares' => array(
                ...
                {
                    if ($resp && isset($resp->data[0]->share_count) && $resp->data[0]->share_count) {
            ...
            'facebooklikes' => array(
                ...
                "callback" => function($resp)
                {
                    if ($resp && isset($resp->data[0]->like_count) && $resp->data[0]->like_count) {
                        return (int) $resp->data[0]->like_count;
                    }
